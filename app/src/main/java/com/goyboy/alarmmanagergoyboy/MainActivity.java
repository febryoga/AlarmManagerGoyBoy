package com.goyboy.alarmmanagergoyboy;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DataPickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
